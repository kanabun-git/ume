...
Rails.application.configure do
  ...
  # Allow access via forwarded dev-environment hostnames (GitHub Codespaces,
  # Gitpod), whose subdomain is random per instance so a fixed host can't be
  # listed. Rails' Host Authorization would otherwise reject these with a
