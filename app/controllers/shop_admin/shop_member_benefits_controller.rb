  ...
  class ShopMemberBenefitsController < BaseController
    ...
    def create
      ...
      if @shop_member_benefit.save
        redirect_to shop_admin_shop_member_ranks_path, notice: "特典を登録しました。"
      else
    ...
    def update
      if @shop_member_benefit.update(shop_member_benefit_params)
        redirect_to shop_admin_shop_member_ranks_path, notice: "特典を更新しました。"
      else
    ...
    def destroy
      ...
      redirect_to shop_admin_shop_member_ranks_path, notice: "特典を削除しました。"
    end

    private

    def set_shop_member_rank
      @shop_member_rank = current_shop.shop_member_ranks.find(params[:shop_member_rank_id])
    end
